...
查找关键字：
<%=search_key%>
<c:set var="search_key" value="<%=search_key%>" scope="page"/>
<br/>
<br/>
<br/>
...
<table border="1">
    ...
    <c:forEach var="row" items="${result.rows}">
        <c:if test="${fn:contains(row.no,search_key)||fn:contains(row.name,search_key)||
        fn:contains(row.sex,search_key)||fn:contains(row.age,search_key)}">
            <tr>
